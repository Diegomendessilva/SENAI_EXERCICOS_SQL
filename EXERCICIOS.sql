...
--ex 9 Faça uma lista com todos os produtos das cores: Green, Orange, Black,
...
where 
	...
	AND ColorName in(  'Green','Orange','Black',
	'Silver', 'Pink')

-- ex 10 A empresa possui 16 produtos da marca Contoso, da cor Silver e com um
--UnitPrice entre 10 e 30. Descubra quais são esses produtos e ordene
--o resultado em ordem decrescente de acordo com o preço (UnitPrice).
